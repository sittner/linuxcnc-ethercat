...
/// @file
/// @brief Driver for Beckhoff EL40x2 Analog output modules

#include "../lcec.h"
#include "lcec_el40x2.h"

static int lcec_el40x2_init(int comp_id, struct lcec_slave *slave, ec_pdo_entry_reg_t *pdo_entry_regs);

static lcec_typelist_t types[]={
  // analog out, 2ch, 12 bits
  { "EL4002", LCEC_BECKHOFF_VID, 0x0fa23052, LCEC_EL40x2_PDOS, 0, NULL, lcec_el40x2_init},
  { "EL4012", LCEC_BECKHOFF_VID, 0x0fac3052, LCEC_EL40x2_PDOS, 0, NULL, lcec_el40x2_init},
  { "EL4022", LCEC_BECKHOFF_VID, 0x0fb63052, LCEC_EL40x2_PDOS, 0, NULL, lcec_el40x2_init},
  { "EL4032", LCEC_BECKHOFF_VID, 0x0fc03052, LCEC_EL40x2_PDOS, 0, NULL, lcec_el40x2_init},
  { NULL },
};
ADD_TYPES(types);
...
static void lcec_el40x2_write(struct lcec_slave *slave, long period);
