...
static int lcec_el41x2_init(int comp_id, struct lcec_slave *slave, ec_pdo_entry_reg_t *pdo_entry_regs);

static lcec_typelist_t types[]={
  // analog out, 2ch, 16 bits
  { "EL4102", LCEC_BECKHOFF_VID, 0x10063052, LCEC_EL41x2_PDOS, 0, NULL, lcec_el41x2_init},
  { "EL4112", LCEC_BECKHOFF_VID, 0x10103052, LCEC_EL41x2_PDOS, 0, NULL, lcec_el41x2_init},
  { "EL4122", LCEC_BECKHOFF_VID, 0x101A3052, LCEC_EL41x2_PDOS, 0, NULL, lcec_el41x2_init},
  { "EL4132", LCEC_BECKHOFF_VID, 0x10243052, LCEC_EL41x2_PDOS, 0, NULL, lcec_el41x2_init},
  { NULL },
};
ADD_TYPES(types);
...
static void lcec_el41x2_write(struct lcec_slave *slave, long period);
