...
static const lcec_pindesc_t slave_pins[] = {
	{ HAL_BIT, HAL_OUT, offsetof(lcec_fr4000_data_t, DROK_0), "%s.%s.%s.axis0-drvok" },
	{ HAL_BIT, HAL_OUT, offsetof(lcec_fr4000_data_t, DROK_1), "%s.%s.%s.axis1-drvok" },
	{ HAL_BIT, HAL_OUT, offsetof(lcec_fr4000_data_t, DROK_2), "%s.%s.%s.axis2-drvok" },
	{ HAL_BIT, HAL_OUT, offsetof(lcec_fr4000_data_t, DROK_3), "%s.%s.%s.axis3-drvok" },
	{ HAL_BIT, HAL_OUT, offsetof(lcec_fr4000_data_t, DROK_4), "%s.%s.%s.axis4-drvok" },
	{ HAL_BIT, HAL_OUT, offsetof(lcec_fr4000_data_t, DROK_INVERTER), "%s.%s.%s.din-inverter-drvok" },
	{ HAL_BIT, HAL_IN, offsetof(lcec_fr4000_data_t, ENABLE_24V_0), "%s.%s.%s.axis0-enable24V" },
	{ HAL_BIT, HAL_IN, offsetof(lcec_fr4000_data_t, ENABLE_24V_1), "%s.%s.%s.axis1-enable24V" },
	{ HAL_BIT, HAL_IN, offsetof(lcec_fr4000_data_t, ENABLE_24V_2), "%s.%s.%s.axis2-enable24V" },
	{ HAL_BIT, HAL_IN, offsetof(lcec_fr4000_data_t, ENABLE_24V_3), "%s.%s.%s.axis3-enable24V" },
	{ HAL_BIT, HAL_IN, offsetof(lcec_fr4000_data_t, ENABLE_24V_4), "%s.%s.%s.axis4-enable24V" },
	{ HAL_BIT, HAL_IN, offsetof(lcec_fr4000_data_t, ENABLE_24V_INVERTER), "%s.%s.%s.dout-inverter-enable" },
	{ HAL_BIT, HAL_IN, offsetof(lcec_fr4000_data_t, ENABLE_5V_0), "%s.%s.%s.axis0-enable5V" },
	{ HAL_BIT, HAL_IN, offsetof(lcec_fr4000_data_t, ENABLE_5V_1), "%s.%s.%s.axis1-enable5V" },
	{ HAL_BIT, HAL_IN, offsetof(lcec_fr4000_data_t, ENABLE_5V_2), "%s.%s.%s.axis2-enable5V" },
	{ HAL_BIT, HAL_IN, offsetof(lcec_fr4000_data_t, ENABLE_5V_3), "%s.%s.%s.axis3-enable5V" },
	{ HAL_BIT, HAL_IN, offsetof(lcec_fr4000_data_t, ENABLE_5V_4), "%s.%s.%s.axis4-enable5V" },
	{ HAL_BIT, HAL_OUT, offsetof(lcec_fr4000_data_t, HOME_0), "%s.%s.%s.axis0-home" },
	{ HAL_BIT, HAL_OUT, offsetof(lcec_fr4000_data_t, HOME_1), "%s.%s.%s.axis1-home" },
	{ HAL_BIT, HAL_OUT, offsetof(lcec_fr4000_data_t, HOME_2), "%s.%s.%s.axis2-home" },
	{ HAL_BIT, HAL_OUT, offsetof(lcec_fr4000_data_t, HOME_3), "%s.%s.%s.axis3-home" },
	{ HAL_BIT, HAL_OUT, offsetof(lcec_fr4000_data_t, HOME_4), "%s.%s.%s.axis4-home" },
	{ HAL_BIT, HAL_OUT, offsetof(lcec_fr4000_data_t, IN_0), "%s.%s.%s.din-0" },
	{ HAL_BIT, HAL_OUT, offsetof(lcec_fr4000_data_t, IN_1), "%s.%s.%s.din-1" },
	{ HAL_BIT, HAL_OUT, offsetof(lcec_fr4000_data_t, IN_2), "%s.%s.%s.din-2" },
	{ HAL_BIT, HAL_OUT, offsetof(lcec_fr4000_data_t, IN_3), "%s.%s.%s.din-3" },
	{ HAL_BIT, HAL_OUT, offsetof(lcec_fr4000_data_t, IN_4), "%s.%s.%s.probe" },
	{ HAL_BIT, HAL_IN, offsetof(lcec_fr4000_data_t, OUT_0), "%s.%s.%s.dout-0" },
	{ HAL_BIT, HAL_IN, offsetof(lcec_fr4000_data_t, OUT_1), "%s.%s.%s.dout-1" },

	{ HAL_S32, HAL_OUT, offsetof(lcec_fr4000_data_t, HZ_0), "%s.%s.%s.axis0-hz" },
	{ HAL_S32, HAL_OUT, offsetof(lcec_fr4000_data_t, HZ_1), "%s.%s.%s.axis1-hz" },
	{ HAL_S32, HAL_OUT, offsetof(lcec_fr4000_data_t, HZ_2), "%s.%s.%s.axis2-hz" },
	{ HAL_S32, HAL_OUT, offsetof(lcec_fr4000_data_t, HZ_3), "%s.%s.%s.axis3-hz" },
	{ HAL_S32, HAL_OUT, offsetof(lcec_fr4000_data_t, HZ_4), "%s.%s.%s.axis4-hz" },

	{ HAL_FLOAT, HAL_OUT, offsetof(lcec_fr4000_data_t, enc_00_position), "%s.%s.%s.axis0-enc-pos" },
	{ HAL_FLOAT, HAL_OUT, offsetof(lcec_fr4000_data_t, enc_01_position), "%s.%s.%s.axis1-enc-pos" },
	{ HAL_FLOAT, HAL_OUT, offsetof(lcec_fr4000_data_t, enc_02_position), "%s.%s.%s.axis2-enc-pos" },
	{ HAL_FLOAT, HAL_OUT, offsetof(lcec_fr4000_data_t, enc_03_position), "%s.%s.%s.axis3-enc-pos" },
	{ HAL_FLOAT, HAL_OUT, offsetof(lcec_fr4000_data_t, enc_04_position), "%s.%s.%s.axis4-enc-pos" },

	{ HAL_S32, HAL_OUT, offsetof(lcec_fr4000_data_t, enc_00_count), "%s.%s.%s.axis0-raw-count" },
	{ HAL_S32, HAL_OUT, offsetof(lcec_fr4000_data_t, enc_01_count), "%s.%s.%s.axis1-raw-count" },
	{ HAL_S32, HAL_OUT, offsetof(lcec_fr4000_data_t, enc_02_count), "%s.%s.%s.axis2-raw-count" },
	{ HAL_S32, HAL_OUT, offsetof(lcec_fr4000_data_t, enc_03_count), "%s.%s.%s.axis3-raw-count" },
	{ HAL_S32, HAL_OUT, offsetof(lcec_fr4000_data_t, enc_04_count), "%s.%s.%s.axis4-raw-count" },

	{ HAL_BIT, HAL_IO, offsetof(lcec_fr4000_data_t, enc_00_index_enable), "%s.%s.%s.axis0-index-enable" },
	{ HAL_BIT, HAL_IO, offsetof(lcec_fr4000_data_t, enc_01_index_enable), "%s.%s.%s.axis1-index-enable" },
	{ HAL_BIT, HAL_IO, offsetof(lcec_fr4000_data_t, enc_02_index_enable), "%s.%s.%s.axis2-index-enable" },
	{ HAL_BIT, HAL_IO, offsetof(lcec_fr4000_data_t, enc_03_index_enable), "%s.%s.%s.axis3-index-enable" },
	{ HAL_BIT, HAL_IO, offsetof(lcec_fr4000_data_t, enc_04_index_enable), "%s.%s.%s.axis4-index-enable" },

	{ HAL_FLOAT, HAL_IN, offsetof(lcec_fr4000_data_t, dac_00_value), "%s.%s.%s.axis0-dac-value" },
	{ HAL_FLOAT, HAL_IN, offsetof(lcec_fr4000_data_t, dac_01_value), "%s.%s.%s.axis1-dac-value" },
	{ HAL_FLOAT, HAL_IN, offsetof(lcec_fr4000_data_t, dac_02_value), "%s.%s.%s.axis2-dac-value" },
	{ HAL_FLOAT, HAL_IN, offsetof(lcec_fr4000_data_t, dac_03_value), "%s.%s.%s.axis3-dac-value" },
	{ HAL_FLOAT, HAL_IN, offsetof(lcec_fr4000_data_t, dac_04_value), "%s.%s.%s.axis4-dac-value" },

	{ HAL_FLOAT, HAL_IN, offsetof(lcec_fr4000_data_t, dac_inverter_value), "%s.%s.%s.inverter-dac-value" },
	{ HAL_BIT, HAL_IN, offsetof(lcec_fr4000_data_t, inverter_forward), "%s.%s.%s.inverter-forward" },
	{ HAL_BIT, HAL_IN, offsetof(lcec_fr4000_data_t, inverter_reverse), "%s.%s.%s.inverter-reverse" },
...
static const lcec_pindesc_t slave_params[] = {
	...
	{ HAL_FLOAT, HAL_RW, offsetof(lcec_fr4000_data_t, enc_04_scale), "%s.%s.%s.axis4-enc-scale" },

	{ HAL_FLOAT, HAL_RW, offsetof(lcec_fr4000_data_t, dac_00_scale), "%s.%s.%s.axis0-dac-scale" },
	{ HAL_FLOAT, HAL_RW, offsetof(lcec_fr4000_data_t, dac_01_scale), "%s.%s.%s.axis1-dac-scale" },
	{ HAL_FLOAT, HAL_RW, offsetof(lcec_fr4000_data_t, dac_02_scale), "%s.%s.%s.axis2-dac-scale" },
	{ HAL_FLOAT, HAL_RW, offsetof(lcec_fr4000_data_t, dac_03_scale), "%s.%s.%s.axis3-dac-scale" },
	{ HAL_FLOAT, HAL_RW, offsetof(lcec_fr4000_data_t, dac_04_scale), "%s.%s.%s.axis4-dac-scale" },

	{ HAL_FLOAT, HAL_RW, offsetof(lcec_fr4000_data_t, set_00_position), "%s.%s.%s.axis0-set-position" },
	{ HAL_FLOAT, HAL_RW, offsetof(lcec_fr4000_data_t, set_01_position), "%s.%s.%s.axis1-set-position" },
	{ HAL_FLOAT, HAL_RW, offsetof(lcec_fr4000_data_t, set_02_position), "%s.%s.%s.axis2-set-position" },
	{ HAL_FLOAT, HAL_RW, offsetof(lcec_fr4000_data_t, set_03_position), "%s.%s.%s.axis3-set-position" },
	{ HAL_FLOAT, HAL_RW, offsetof(lcec_fr4000_data_t, set_04_position), "%s.%s.%s.axis4-set-position" },

	{ HAL_BIT, HAL_RW, offsetof(lcec_fr4000_data_t, update_00_position), "%s.%s.%s.axis0-update-position" },
	{ HAL_BIT, HAL_RW, offsetof(lcec_fr4000_data_t, update_01_position), "%s.%s.%s.axis1-update-position" },
	{ HAL_BIT, HAL_RW, offsetof(lcec_fr4000_data_t, update_02_position), "%s.%s.%s.axis2-update-position" },
...
static ec_pdo_entry_info_t lcec_fr4000_pdo_entries[] = {
	...
	{ 0x7001, 0x01, 32 }, /* Drive 1 freq */
	{ 0x7001, 0x02, 32 }, /* Drive 2 freq */
	{ 0x7001, 0x03, 32 }, /* Drive 3 freq */
	{ 0x7001, 0x04, 32 }, /* Drive 4 freq */
	{ 0x7001, 0x05, 32 }, /* Drive 5 freq */
	...
	{ 0x7004, 0x07, 1 }, /* Polarita' Impulsi */
	{ 0x0000, 0x08, 1 }, /* Pad */
	{ 0x7005, 0x01, 1 }, /* Drive 1 single */
	{ 0x7005, 0x02, 1 }, /* Drive 2 single */
	{ 0x7005, 0x03, 1 }, /* Drive 3 single */
	{ 0x7005, 0x04, 1 }, /* Drive 4 single */
	{ 0x7005, 0x05, 1 }, /* Drive 5 single */
	{ 0x0000, 0x06, 1 }, /* Pad */
	{ 0x0000, 0x07, 1 }, /* Pad */
	{ 0x0000, 0x08, 1 }, /* Pad */
...
static ec_pdo_info_t lcec_fr4000_pdos[] = {
	{ 0x1600, 1, lcec_fr4000_pdo_entries + 0 }, /* Velocita' mandrino */
	{ 0x1601, 5, lcec_fr4000_pdo_entries + 1 }, /* Frequenza drive */
	{ 0x1602, 8, lcec_fr4000_pdo_entries + 6 }, /* Abilitazione drive */
	{ 0x1603, 8, lcec_fr4000_pdo_entries + 14 }, /* Direzione drive */
	{ 0x1604, 8, lcec_fr4000_pdo_entries + 22 }, /* Comandi drive */
	{ 0x1605, 8, lcec_fr4000_pdo_entries + 30 }, /* Impulso singolo */
	{ 0x1606, 8, lcec_fr4000_pdo_entries + 38 }, /* Uscite digitali */
	{ 0x1a00, 2, lcec_fr4000_pdo_entries + 46 }, /* Ingressi analogici */
	{ 0x1a01, 5, lcec_fr4000_pdo_entries + 48 }, /* Contatore impulsi */
	{ 0x1a02, 5, lcec_fr4000_pdo_entries + 53 }, /* Latch impulsi */
	{ 0x1a06, 8, lcec_fr4000_pdo_entries + 58 }, /* Flag latch idx/probe */
	{ 0x1a04, 8, lcec_fr4000_pdo_entries + 66 }, /* Home */
	{ 0x1a03, 8, lcec_fr4000_pdo_entries + 74 }, /* Stato drive */
	{ 0x1a05, 8, lcec_fr4000_pdo_entries + 82 }, /* Index */
...
int lcec_fr4000_init(int comp_id, struct lcec_slave *slave, ec_pdo_entry_reg_t *pdo_entry_regs) {
  ...
  slave->proc_read = lcec_fr4000_read;
...
void lcec_fr4000_write(struct lcec_slave *slave, long period) {
  ...
  fValue = (((*(hal_data->dac_00_value) * 1000) / hal_data->enc_00_scale)) * hal_data->dac_00_scale;
  /*if (fValue > 65534)
  {
	  fValue = 65534;
  }
  ...
  *(hal_data->HZ_0) = fTmp;
  ...
  fValue = (((*(hal_data->dac_01_value) * 1000) / hal_data->enc_01_scale)) * hal_data->dac_01_scale;
  /*if (fValue > 65534)
  {
	  fValue = 65534;
  }
  ...
  *(hal_data->HZ_1) = fTmp;
  ...
  fValue = (((*(hal_data->dac_02_value) * 1000) / hal_data->enc_02_scale)) * hal_data->dac_02_scale;
  /*if (fValue > 65534)
  {
	  fValue = 65534;
  }
  ...
  *(hal_data->HZ_2) = fTmp;
  ...
  fValue = (((*(hal_data->dac_03_value) * 1000) / hal_data->enc_03_scale)) * hal_data->dac_03_scale;
  /*if (fValue > 65534)
  {
	  fValue = 65534;
  }
  ...
  *(hal_data->HZ_3) = fTmp;
  ...
  fValue = (((*(hal_data->dac_04_value) * 1000) / hal_data->enc_04_scale)) * hal_data->dac_04_scale;
  /*if (fValue > 65534)
  {
	  fValue = 65534;
  }
