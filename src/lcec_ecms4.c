...
/**   
  ...
  The peripheral follows the "Modular device profile" in order to permit the 
  indipendent configuration of both motor control channels.
...
HAL Parameters:
 ...
 Default ECMS4 configuration is for a single channel motor drive, seen by IgH master:
\code
...
\details
 ...
 After the configuration of 2 CST slots (using SDOs for
 ...
 SDO 0xf030, "Configured module Ident list"
 SDO 0xf050, "Module detected list"), 
ECMS4 configuration seen by IgH master:
...
SM2: PhysAddr 0x1800, DefaultSize    0, ControlRegister 0x64, Enable 1
  RxPDO 0x1603 "cst RxPDO "
    ...
    PDO entry 0x6071:00, 16 bit, "SubIndex 000"
    PDO entry 0x60b2:00, 16 bit, "SubIndex 000"
  RxPDO 0x1613 "cst RxPDO "
    PDO entry 0x6840:00, 16 bit, "SubIndex 000"
    PDO entry 0x6871:00, 16 bit, "SubIndex 000"
    PDO entry 0x68b2:00, 16 bit, "SubIndex 000"
SM3: PhysAddr 0x1c00, DefaultSize    0, ControlRegister 0x20, Enable 1
  TxPDO 0x1a03 "cst TxPDO "
    PDO entry 0x6041:00, 16 bit, "SubIndex 000"
    PDO entry 0x6064:00, 32 bit, "SubIndex 000"
    PDO entry 0x606c:00, 32 bit, "SubIndex 000"
    PDO entry 0x6077:00, 16 bit, "SubIndex 000"
  TxPDO 0x1a13 "cst TxPDO "
    PDO entry 0x6841:00, 16 bit, "SubIndex 000"
    PDO entry 0x6864:00, 32 bit, "SubIndex 000"
    PDO entry 0x686c:00, 32 bit, "SubIndex 000"
    PDO entry 0x6877:00, 16 bit, "SubIndex 000"
...
SDO 0x1611, "csp RxPDO"
  0x1611:00, r-r-r-, uint8, 8 bit, "SubIndex 000"
  0x1611:01, r-r-r-, uint32, 32 bit, "SubIndex 001"
  0x1611:02, r-r-r-, uint32, 32 bit, "SubIndex 002"
SDO 0x1612, "csv RxPDO"
  0x1612:00, r-r-r-, uint8, 8 bit, "SubIndex 000"
  0x1612:01, r-r-r-, uint32, 32 bit, "SubIndex 001"
  0x1612:02, r-r-r-, uint32, 32 bit, "SubIndex 002"
SDO 0x1613, "cst RxPDO "
  0x1613:00, r-r-r-, uint8, 8 bit, "SubIndex 000"
  0x1613:01, r-r-r-, uint32, 32 bit, "Control Word "
  0x1613:02, r-r-r-, uint32, 32 bit, "Target Torque "
  0x1613:03, r-r-r-, uint32, 32 bit, "Torque offset "
SDO 0x1a00, "csp/csv TxPDO"
  0x1a00:00, r-r-r-, uint8, 8 bit, "SubIndex 000"
  0x1a00:01, r-r-r-, uint32, 32 bit, "SubIndex 001"
  0x1a00:02, r-r-r-, uint32, 32 bit, "SubIndex 002"
...
SDO 0x1a11, "csp TxPDO"
  0x1a11:00, r-r-r-, uint8, 8 bit, "SubIndex 000"
  0x1a11:01, r-r-r-, uint32, 32 bit, "SubIndex 001"
  0x1a11:02, r-r-r-, uint32, 32 bit, "SubIndex 002"
SDO 0x1a12, "csv TxPDO"
  0x1a12:00, r-r-r-, uint8, 8 bit, "SubIndex 000"
  0x1a12:01, r-r-r-, uint32, 32 bit, "SubIndex 001"
  0x1a12:02, r-r-r-, uint32, 32 bit, "SubIndex 002"
SDO 0x1a13, "cst TxPDO "
  0x1a13:00, r-r-r-, uint8, 8 bit, "SubIndex 000"
  0x1a13:01, r-r-r-, uint32, 32 bit, "Status Word "
  0x1a13:02, r-r-r-, uint32, 32 bit, "Actual Position "
  0x1a13:03, r-r-r-, uint32, 32 bit, "Actual velocity "
  0x1a13:04, r-r-r-, uint32, 32 bit, "Actual Torque "
SDO 0x1c00, "Sync manager type"
  0x1c00:00, r-r-r-, uint8, 8 bit, "SubIndex 000"
  0x1c00:01, r-r-r-, uint8, 8 bit, "SubIndex 001"
  0x1c00:02, r-r-r-, uint8, 8 bit, "SubIndex 002"
...
SDO 0x683f, "Error Code"
  0x683f:00, r-r-r-, uint16, 16 bit, "SubIndex 000"
SDO 0x6840, "Control Word"
  0x6840:00, rwrwrw, uint16, 16 bit, "SubIndex 000"
SDO 0x6841, "Status Word"
  0x6841:00, r-r-r-, uint16, 16 bit, "SubIndex 000"
SDO 0x685a, "Quickstop Option Code"
  0x685a:00, rwrwrw, int16, 16 bit, "SubIndex 000"
SDO 0x685b, "Shutdown Option Code"
  0x685b:00, rwrwrw, int16, 16 bit, "SubIndex 000"
SDO 0x685c, "Disable Operation Option Code"
  0x685c:00, rwrwrw, int16, 16 bit, "SubIndex 000"
SDO 0x685e, "Fault Reaction Code"
  0x685e:00, rwrwrw, int16, 16 bit, "SubIndex 000"
SDO 0x6860, "Modes of Operation"
  0x6860:00, rwrwrw, int8, 8 bit, "SubIndex 000"
SDO 0x6861, "Modes of Operation Display"
  0x6861:00, r-r-r-, int8, 8 bit, "SubIndex 000"
SDO 0x6864, "Position Actual Value"
  0x6864:00, r-r-r-, int32, 32 bit, "SubIndex 000"
SDO 0x686c, "Velocity Actual Value"
  0x686c:00, r-r-r-, int32, 32 bit, "SubIndex 000"
SDO 0x6871, "Target Torque"
  0x6871:00, rwrwrw, int16, 16 bit, "SubIndex 000"
SDO 0x6877, "Torque Actual Value"
  0x6877:00, r-r-r-, int16, 16 bit, "SubIndex 000"
SDO 0x687a, "Target Position"
  0x687a:00, rwrwrw, int32, 32 bit, "SubIndex 000"
...
SDO 0x6885, "Quickstop Declaration"
  0x6885:00, rwrwrw, int32, 32 bit, "SubIndex 000"
SDO 0x68b2, "Torque Offset"
  0x68b2:00, rwrwrw, int16, 16 bit, "SubIndex 000"
SDO 0x68c2, "Interpolation Time Period"
  0x68c2:00, r-r-r-, uint8, 8 bit, "SubIndex 000"
  0x68c2:01, rwrwrw, uint8, 8 bit, "Interpolation period "
  0x68c2:02, rwrwrw, int8, 8 bit, "Interpolation Index"
SDO 0x68ff, "Target Velocity"
  0x68ff:00, rwrwrw, int32, 32 bit, "SubIndex 000"
SDO 0x6d02, "Supported Drive Modes"
  0x6d02:00, r-r-r-, uint32, 32 bit, "SubIndex 000"
SDO 0xf000, "Modular device profile"
  0xf000:00, r-r-r-, uint8, 8 bit, "SubIndex 000"
  0xf000:01, r-r-r-, uint16, 16 bit, "Module index distance"
  0xf000:02, r-r-r-, uint16, 16 bit, "Maximum number of modules"
...
ec_pdo_entry_info_t lcec_ecms4_rxpdo_ch1_entries[] = {
...
ec_pdo_entry_info_t lcec_ecms4_rxpdo_ch2_entries[] = {
    {0x6840, 0x00, 16}, /* SubIndex 000 */ // Control Word
    {0x6871, 0x00, 16}, /* SubIndex 000 */ // Target torque
    {0x68b2, 0x00, 16}  /* SubIndex 000 */ // Torque offset
};

// CST TxPDOs
ec_pdo_entry_info_t lcec_ecms4_txpdo_ch1_entries[] = {
...
ec_pdo_entry_info_t lcec_ecms4_txpdo_ch2_entries[] = {
    {0x6841, 0x00, 16}, /* SubIndex 000 */ // Status word
    {0x6864, 0x00, 32}, /* SubIndex 000 */ // Position actual value
    {0x686c, 0x00, 32}, /* SubIndex 000 */ // Velocity actual value
    {0x6877, 0x00, 16}  /* SubIndex 000 */ // Torque   actual value
};

//  Index,  n.PDOs, array of PDO entries
ec_pdo_info_t lcec_ecms4_rxpdos[] = {
    {0x1603, 3, lcec_ecms4_rxpdo_ch1_entries}, /* cst RxPDO  */
    {0x1613, 3, lcec_ecms4_rxpdo_ch2_entries} /* cst RxPDO  */
};
ec_pdo_info_t lcec_ecms4_txpdos[] = {
    {0x1a03, 4, lcec_ecms4_txpdo_ch1_entries},  /* cst TxPDO  */
    {0x1a13, 4, lcec_ecms4_txpdo_ch2_entries}  /* cst TxPDO  */
};
...
ec_sync_info_t lcec_ecms4_syncs[] = {
    ...
    {2, EC_DIR_OUTPUT, 2, lcec_ecms4_rxpdos,   EC_WD_ENABLE},
    {3, EC_DIR_INPUT,  2, lcec_ecms4_txpdos,   EC_WD_DISABLE},
    {0xff}
};
...
// \todo: add PDOs for channel 2
  LCEC_PDO_INIT(pdo_entry_regs, slave->index, slave->vid, slave->pid, 0x6040, 0x00, &hal_data->chans[0].ec_control_offs, NULL);
  LCEC_PDO_INIT(pdo_entry_regs, slave->index, slave->vid, slave->pid, 0x6071, 0x00, &hal_data->chans[0].ec_target_torque_offs, NULL);
  LCEC_PDO_INIT(pdo_entry_regs, slave->index, slave->vid, slave->pid, 0x60b2, 0x00, &hal_data->chans[0].ec_torque_offset_offs, NULL);

  LCEC_PDO_INIT(pdo_entry_regs, slave->index, slave->vid, slave->pid, 0x6840, 0x00, &hal_data->chans[1].ec_control_offs, NULL);
  LCEC_PDO_INIT(pdo_entry_regs, slave->index, slave->vid, slave->pid, 0x6871, 0x00, &hal_data->chans[1].ec_target_torque_offs, NULL);
  LCEC_PDO_INIT(pdo_entry_regs, slave->index, slave->vid, slave->pid, 0x68b2, 0x00, &hal_data->chans[1].ec_torque_offset_offs, NULL);

  LCEC_PDO_INIT(pdo_entry_regs, slave->index, slave->vid, slave->pid, 0x6041, 0x00, &hal_data->chans[0].ec_status_offs, NULL);
  LCEC_PDO_INIT(pdo_entry_regs, slave->index, slave->vid, slave->pid, 0x6064, 0x00, &hal_data->chans[0].ec_actual_position_offs, NULL);
  LCEC_PDO_INIT(pdo_entry_regs, slave->index, slave->vid, slave->pid, 0x606c, 0x00, &hal_data->chans[0].ec_actual_velocity_offs, NULL);
  LCEC_PDO_INIT(pdo_entry_regs, slave->index, slave->vid, slave->pid, 0x6077, 0x00, &hal_data->chans[0].ec_actual_torque_offs, NULL);

  LCEC_PDO_INIT(pdo_entry_regs, slave->index, slave->vid, slave->pid, 0x6841, 0x00, &hal_data->chans[1].ec_status_offs, NULL);
  LCEC_PDO_INIT(pdo_entry_regs, slave->index, slave->vid, slave->pid, 0x6864, 0x00, &hal_data->chans[1].ec_actual_position_offs, NULL);
  LCEC_PDO_INIT(pdo_entry_regs, slave->index, slave->vid, slave->pid, 0x686c, 0x00, &hal_data->chans[1].ec_actual_velocity_offs, NULL);
  LCEC_PDO_INIT(pdo_entry_regs, slave->index, slave->vid, slave->pid, 0x6877, 0x00, &hal_data->chans[1].ec_actual_torque_offs, NULL);
